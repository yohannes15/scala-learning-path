...
**Collections** are how you work with structured data in almost every Scala program. Scala’s library splits **immutable** vs **mutable** hierarchies and offers rich **combinators** (`map`, `flatMap`, `fold`, …). Learning the core types and operations makes everyday code shorter and safer.
